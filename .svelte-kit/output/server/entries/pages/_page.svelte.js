import { c as create_ssr_component, o as onDestroy, d as spread, f as escape_object, h as createEventDispatcher, i as add_attribute, v as validate_component, e as escape, j as each } from "../../chunks/ssr.js";
...
function categorize(values, defaultCategory = "uncategorized") {
  return values.reduce((catVals, val) => {
    const category = val.category || defaultCategory;
    if (catVals[category] === void 0) {
      catVals[category] = [];
    }
...
function processIconName(icon) {
  return icon.includes(":") ? icon : [DEFAULT_ICON_FAMILY, icon].join(":");
}
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { app } = $$props;
  if ($$props.app === void 0 && $$bindings.app && app !== void 0)
    $$bindings.app(app);
  return `<a class="w-100 transition-colors text-gray-700 dark:text-gray-200 hover:text-blue-500 text-left"${add_attribute("target", app.tab ? "_blank" : "_self", 0)}${add_attribute("href", app.url, 0)}><div class="max-w-sm rounded overflow-hidden p-4 flex items-start space-x-4"><div class="flex-shrink-0 mt-0 text-[48px] pt-0">${app.icon_data ? `${app.icon_data.toString().startsWith("http") ? `<img width="48px"${add_attribute("src", app.icon_data.toString(), 0)} alt="">` : `${validate_component(Icon, "Icon").$$render($$result, { icon: app.icon_data }, {}, {})}`}` : `${validate_component(Icon, "Icon").$$render($$result, { icon: processIconName(app.icon) }, {}, {})}`}</div> <div><div class="font-bold text-xl mb-0">${escape(app.name)}</div> <p class="text-gray-700 dark:text-gray-200 text-base">${escape(app.url_display || getHost(app.url))}</p></div></div></a>`;
});
const Section = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { title } = $$props;
  if ($$props.title === void 0 && $$bindings.title && title !== void 0)
    $$bindings.title(title);
  return `<p class="font-light text-3xl pb-2 md:pb-5 pt-4 md:pt-6">${escape(titleCase(title))}:</p> ${slots.default ? slots.default({}) : ``}`;
});
const Subsection = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { subtitle } = $$props;
  if ($$props.subtitle === void 0 && $$bindings.subtitle && subtitle !== void 0)
    $$bindings.subtitle(subtitle);
  return `<p class="font-semibold text-lg">${escape(titleCase(subtitle))}:</p> ${slots.default ? slots.default({}) : ``}`;
});
const AppList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.apps === void 0 && $$bindings.apps && apps !== void 0)
    $$bindings.apps(apps);
  appsCategorized = categorize(apps);
  return `${validate_component(Section, "Section").$$render($$result, { title: "Applications" }, {}, {
    default: () => {
      return `${each(Object.keys(appsCategorized), (cat) => {
        return `${validate_component(Subsection, "Subsection").$$render($$result, { subtitle: cat }, {}, {
          default: () => {
            return `<div class="flex flex-wrap">${each(appsCategorized[cat], (app) => {
              return `<div class="w-full sm:w-1/2 xl:w-1/3 2xl:w-1/4">${validate_component(App, "App").$$render($$result, { app }, {}, {})} </div>`;
            })}</div> `;
          }
        })}`;
      })}`;
...
const BookmarkList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let bookmarksCategorized;
  let { bookmarks } = $$props;
  if ($$props.bookmarks === void 0 && $$bindings.bookmarks && bookmarks !== void 0)
    $$bindings.bookmarks(bookmarks);
  bookmarksCategorized = categorize(bookmarks);
  return `${validate_component(Section, "Section").$$render($$result, { title: "Bookmarks" }, {}, {
    default: () => {
      return `<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">${each(Object.keys(bookmarksCategorized), (cat) => {
        return `<div class="col-span-1">${validate_component(Subsection, "Subsection").$$render($$result, { subtitle: cat }, {}, {
          default: () => {
            return `<div class="flex flex-col">${each(bookmarksCategorized[cat], (bookmark) => {
              return `<a class="flex flex-row"${add_attribute("href", bookmark.url, 0)}${add_attribute("target", bookmark.new_tab ? "_blank" : "_self", 0)}>${escape(bookmark.name)} </a>`;
            })}</div> `;
          }
        })} </div>`;
      })}</div>`;
...
const Heading = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  formatted = formatTime(datetime, /* @__PURE__ */ new Date());
  return `<p class="font-sans text-3xl">${escape(title)}</p> ${datetime ? `<p class="font-mono text-lg">${escape(formatted)}</p>` : ``}`;
});
const _page_svelte_svelte_type_style_lang = "";
const css = {
  code: ".js-content.svelte-2hhcdh{display:none}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Heading, "Heading").$$render(
    ...
    {},
    {}
  )}  <noscript>${data.apps.length > 0 ? `${validate_component(AppList, "AppList").$$render($$result, { apps: data.apps }, {}, {})}` : ``} ${data.bookmarks.length > 0 ? `${validate_component(BookmarkList, "BookmarkList").$$render($$result, { bookmarks: data.bookmarks }, {}, {})}` : ``}</noscript> <div class="js-content svelte-2hhcdh">${loading ? `<div class="fixed inset-0 flex items-center justify-center">${validate_component(Circle, "Circle").$$render(
    $$result,
    {
      size: "120",
      color: "gray",
    ...
    {},
    {}
  )}</div>` : `${data.apps.length > 0 ? `${validate_component(AppList, "AppList").$$render($$result, { apps: data.apps }, {}, {})}` : ``} ${data.bookmarks.length > 0 ? `${validate_component(BookmarkList, "BookmarkList").$$render($$result, { bookmarks: data.bookmarks }, {}, {})}` : ``}`} </div>`;
});
export {
  Page as default
};
